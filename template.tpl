...

{
  ...
  "description": "Record your website visitor’s journey for unlimited websites. Create your account at https://infinity.500apps.com/siterecording to analyze user behavior, optimize the user experience and improve conve",
  "containerContexts": [
    "WEB"
  ]
}
