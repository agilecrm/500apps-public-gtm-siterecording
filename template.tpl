...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Siterecording by 500apps",
  "brand": {
    "id": "brand_dummy",
    "displayName": "",
  ...
  "description": "Site Recording - Visitor Tracking Software",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  {
    ...
    "help": "Please copy the Siterecording Key from the share script sidebar in the application."
  }
]
